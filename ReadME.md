...
```bash
curl -fsSL https://raw.githubusercontent.com/Pratya-Amrit1/OwlOps/main/docker-compose.yml -o docker-compose.yml && nano docker-compose.yml && docker compose up -d
```
> Download → Edit your SMTP credentials → Run. That's it.
...
services:
  owlops:
    image: karmapratya/owlops-monitoring:latest
    ports:
      - "3000:3000"
    volumes:
